    ...
    //criação das variaves apos o receber a resposta da pagina select
                 for (let i = 0; i < resposta.quant; i++) {
                  ...
                  //criação da tabela para exebição do resultado
                      $('.carro  td.descri').append(" <tr><td  class='col-4'><p class='  text-capitalize   id='des'  value='"+desc+"'>"+desc +'</p></td></tr>')
                      $('.carro  td.marca').append(" <tr><td  class='col-4'><p class='  text-capitalize    id='mar'  value='"+mar+"'>"+mar +'</p></td></tr>')
                      $('.carro  td.modelo').append(" <tr><td  class='col-4'><p class='  text-capitalize   id='mod'  value='"+mod+"'>"+mod +'</p></td></tr>')
                      $('.carro  td.tipov').append(" <tr><td  class='col-4'><p class='  text-capitalize    id='tpv'  value='"+tpv+"'>"+tpv +'</p></td></tr>')
                      $('.carro  td.quantp').append(" <tr><td  class='col-4'><p class='  text-capitalize   id='qnt'  value='"+qntp+"'>"+qntp +'</p></td></tr>')
                      $('.carro  td.vlvenda').append(" <tr><td  class='col-4'><p class='  text-capitalize  id='vlv'  value='"+vlv+"'>"+vlv +'</p></td></tr>')
                      $('.carro  td.vlcompra').append(" <tr><td  class='col-4'><p class='  text-capitalize id='vlc'  value='"+vlc+"'>"+vlc +'</p></td></tr>')
                      $('.carro  td.dtcompra').append(" <tr><td  class='col-4'><p class='  text-capitalize id='dtc'  value='"+dtc+"'>"+dtc +'</p></td></tr>')
                      $('.carro  td.estato').append(" <tr><td  class='col-4'><p class='  text-capitalize   id='st'  value='"+st+"'>"+st +'</p></td></tr>')
                      $('.carro  td.id').append(" <tr><td  class='col-4'><button  class='r btn btn-sm btn-primary nav-link' id='idvalor' type='button' data-toggle='modal' data-target='#atualFormulario' value='"+id+"'><i class='far fa-edit'>"+"Edit"+'</i></button></td></tr>')
                      $('.carro  td.ider').append("<tr><td  class='col-4'><button class='del btn btn-sm btn-danger nav-link' type='button' name='idel' value='"+id+"'><i class='far fa-trash-alt'>"+"Del"+'</i></button></td></tr>')
